          ...
          <nav className="space-y-2">
            {policySections.map((section, index) => (
              <button
                ...
                className={`flex items-center w-full text-left px-4 py-3 rounded-lg hover:bg-blue-50 transition-transform duration-200 ease-in-out ${
                  activeSection === section.id ? "bg-blue-50 font-semibold text-blue-600" : "text-gray-700"
                }`}
              >
